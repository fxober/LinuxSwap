#################################################################################
# Initial parameters
# be sure swap space allows for about 25% more than what you are oversubscribing
# ex: 184G total memory, should have about 150GB of swap space, here we do 14 x 21G
# because of drive space available, 14 x 11G = 154G
